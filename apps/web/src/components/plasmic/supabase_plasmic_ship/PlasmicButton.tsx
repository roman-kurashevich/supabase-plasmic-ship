...
import sty from "./PlasmicButton.module.css"; // plasmic-import: MMlaHY98rX/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: NsjwX0wYFV/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 7M8vFcVb-L/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nKySl)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__abOwv)}
                role={"img"}
              />
            ),
